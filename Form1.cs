    ...
    public partial class Formfhf : Form
    {
        ...
        private void Button_findIDs_Click(object sender, EventArgs e)
        {
            DialogResult dr = MessageBox.Show("Нажимая \"Ок\", вы соглашаетесь с автоматическим получением программой идентификаторов устройства." + Environment.NewLine +
                ...
                "После получения идентификаторов данные будут сверены со Справочником ID. Если полученные в автоматическом режиме данные будут отсутствовать или отличаться от данных Справочника, то в канал \"Firehose-Finder issues\" будет отправлено сообщение о включении/редактировании Справочника.",
